...
together we learn and grow
      ...
      <div className="lg:px-16 px-1 flex  lg:flex-row flex-col lg:justify-center justify-between items-center py-6 text-[#343A40] font-light lg:text-[16px] text-[14px] ">
        <div className="flex lg:flex-row flex-col lg:gap-6 gap-1">
