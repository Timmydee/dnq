      ...
      <div className="bg-[#060028] h-[100vh] relative borderDash">
        ...
        <div className="fle items-center justify-center">
          <div className="flex-col justify-start items-start text-white text-[24px] w-full text-lg ">
            <div className="mt-6 w-full paddingX flex items-center space-x-4 cursor-pointer hoverBg">
              <Image src="/element3.png" width={30} height={30} alt="dnqHome" />
              <Link href="/dashboard/home">Home</Link>
            </div>

            <div className="mt-3 w-full paddingX flex items-center space-x-4 cursor-pointer hoverBg ">
              <Image
            ...
            <div className="mt-3 paddingX py-[1rem] w-full flex items-center space-x-4 cursor-pointer hoverBg">
            ...
            <div className="absolute bottom-[10%] mt-6 paddingX py-[1rem] w-full flex items-center space-x-4 cursor-pointer hoverBg">
